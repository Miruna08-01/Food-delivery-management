...
public class EmployeeLogIn {
    ...
    public EmployeeLogIn(DeliveryService del){
        this.del=del;
        ...
        login.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                del.getClients();
                if(del.validateEmployee(nameTxt.getText(), passwordTxt.getText()))
                {
                    frame.dispose();
                    EmployeeView employeeView=new EmployeeView(del,1);
                }
                else
                    JOptionPane.showMessageDialog(frame, "Wrong username or password!",
                            "Employee", JOptionPane.ERROR_MESSAGE);
        ...
        signin.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                if (del.validateNewEmployee(nameTxt.getText(),passwordTxt.getText())) {
                    frame.dispose();
                    EmployeeView employeeView=new EmployeeView(del,1);
